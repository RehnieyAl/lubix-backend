...
def EmailLoginUser(
    ...
    subject = "Inicio de sesión exitoso en Lubix"
            ...
            <table width="650" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td align="center" style="background:linear-gradient(135deg,#0f172a,#1e3a8a,#065f46); padding:60px 40px;">
                        ...
                        <p style="margin-top:12px; color:#cbd5e1; font-size:15px;">Tu acceso seguro a la plataforma</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:45px;">
                        <h2 style="text-align:center; color:#ffffff; font-size:26px;">Inicio de sesión exitoso</h2>

                        <p style="text-align:center; color:#cbd5e1; font-size:16px; line-height:1.7;">
                            Hola <strong style="color:#22c55e;">{username}</strong>, se ha iniciado sesión de manera correcta en tu cuenta.
                        </p>

                        <p style="text-align:center; color:#94a3b8; font-size:14px; line-height:1.7;">
                            Ya puedes explorar todas las funcionalidades disponibles en Lubix.
                        </p>

                        <!-- STATUS -->
                        <div style="margin-top:30px; padding:18px; background:#052e1b; border-left:5px solid #22c55e; border-radius:10px;">
                            <p style="margin:0; color:#22c55e; font-weight:bold;">✔ Sesión iniciada correctamente</p>
                            <p style="margin-top:8px; color:#86efac; font-size:14px;">Tu acceso está activo y seguro.</p>
                        </div>

                        <p style="text-align:center; margin-top:35px; color:#64748b; font-size:13px;">Gracias por confiar en Lubix</p>
                    </td>
                </tr>
